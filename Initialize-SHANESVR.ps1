...
# 4. Configuration of NTP by setting DC to external NIST server time
...
# 15. Creating OU, Users, and Groups
...
Add-DNSServerResourceRecordA -Name "SHANEFW" -ZoneName "AD.SMHCOMPUTERS.COM" -IPv4Address "10.0.0.1" -ComputerName "SHANESVR"
...
Add-DNSServerResourceRecordPtr -Name '1' -ZoneName '0.0.10.in-addr.arpa' -PtrDomainName 'SHANEFW.AD.SMHCOMPUTERS.COM' -ComputerName "SHANESVR"

# Confirm DNS Records 
Get-DNSServerResourceRecord -ZoneName "AD.SMHCOMPUTERS.COM" -ComputerName "SHANESVR"

# 17. Installation and Configuration of DHCP
...
Add-DhcpServerv4Reservation -Name "SHANECLT" -ScopeId 10.0.0.0 -IPAddress 10.0.0.40 -ClientID "<CLIENTMAC>" -Description "Reserved IP Address for SHANECLT"
